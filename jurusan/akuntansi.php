...
<body>
    ...
    <div class="container atas">
        <p class="fs-1 fw-light pt-5">Sarjana Akuntansi</p>
        <img src="../img/akuntan.jpg" alt="" width="1200px" class="img-fluid pt-4">

        <p class="fs-3 fw-normal text-primary pt-5">Deskripsi jurusan</p>
        <hr>
        <hr>
        <p class="fst-normal text-muted">Jurusan Akuntansi adalah bidang studi yang mempelajari materi terkait metode pencatatan dan penyusunan laporan keuangan yang berguna membantu pemangku kepentingan dalam proses pengambilan keputusan. Jurusan Akuntansi dikenal sebagai jurusan yang sangat dekat dengan angka, khususnya segala sesuatu yang terkait dengan keuangan. Meskipun begitu, mahasiswa Jurusan Akuntansi tidak hanya belajar tentang cara menghitung uang, termasuk juga tentang manajemen, perpajakan, sistem informasi, hingga pengauditan.</p>
        ...
        <hr>
        <ul>
            <li>Siswa diharap memiliki kemampuan untuk membaca laporan keuangan sertan mengambil keputusan dari itu</li>
            <li>Siswa diharapkan bisa mengaudit keuangan perusahaan yang akan ditujunya</li>
            <li>Siswa diharapkan memiliki kemampuan untuk menjalankan sebuah bisnis dan mengelola keuangannya</li>
            <li>Siswa dilatih memiliki perilaku yang baik sesuai dengan etika bisnis</li>
        </ul>
        <br><br>
        <p class="fs-3 fw-normal text-primary">Prospek karir</p>
        <hr>
        <hr>
        <p>ulusan Program Studi Sarjana Akuntansi dapat berkarir sebagai Junior Auditor di Kantor Akuntan Publik; Analis sistem / proses bisnis dan  Pengembang Sistem Informasi Akuntansi dan serta manajer tingkat pertama di bidang Akuntansi, Perpajakan, dan Keuangan di berbagai perusahaan bisnis, maupun di instansi pemerintahan,  dapat pula berprofesi sebagai tenaga pendidik untuk mengajar ilmu akuntansi baik sebagai guru maupun asisten dosen.</p>
