...
<body>
    ...
    <div class="container atas">
        <p class="fs-1 fw-light pt-5">Sarjana Manajement</p>
        <img src="../img/Pegawai-kantor.jpeg" alt="" width="1200px" class="img-fluid pt-4">

        <p class="fs-3 fw-normal text-primary pt-5">Deskripsi Jurusan</p>
        <hr>
        <hr>
        <p>Manajemen adalah proses untuk mencapai tujuan, yang meliputi perencanaan, pengorganisasian, pengarahan dan pengendalian. Oleh karena itu manajemen digunakan di semua organisasi dalam rangka mencapai tujuannya, baik organisasi profit (perusahaan /organisasi bisnis) maupun organisasi non-profit (pemerintahan, lembaga sosial, organisasi kemasyarakatan); di semua sektor : perbankan, manufaktur, pertambangan, perdagangan, kesehatan, pariwisata, dll; yang ukurannya kecil, menengah maupun besar. Oleh karena sifatnya yang sangat universal, maka banyak orang merasa perlu mempelajari manajemen.</p>
        <p class="fs-3 fw-normal text-primary">Tujuan pendidikan </p>
        <hr>
        <hr>
        <p>Di program studi Manajemen mahasiswa akan mempelajari berbagai mata kuliah yang akan mengembangkan peserta didik (mahasiswa) untuk :</p>
        <ul>
            <li>Mampu menyusun perencanaan, melakukan pengorganisasian, penyusunan staf, memimpin dan mengarahkan orang lain, dan melakukan pengendalian dalam rangka mengelola suatu organisasai bisnis dan non bisnis.</li>
            <li>Mampu melaksanakan tugas-tugas manajer fungsional (Pemasaran, Operasi, SDM,, Keuangan) dan wirausaha pada suatu organisasi bisnis dan non bisnis.</li>
            <li>Mampu memecahkan permasalahan operasional dan manajerial, memilih solusi terbaik, menyusun rekomendasi keputusan, dan rencana tindakan dengan memanfaatkan teknologi informasi dan komunikasi.</li>
            <li>Mampu menyusun perencanaan bisnis (<em>business plan</em>)</li>
            <li>Mampu melakukan pengumpulan dan pengolahan data serta menganalisis informasi yang relevan dalam proses penelitian.</li>
            <li>Mampu memahami teori, konsep, metoda dan perangkat analisis yang terkait dengan keterampilan manajerial di bidang Pemasaran, SDM, Operasi, dan Keuangan.</li>
        </ul>
        <br><br>
        <p class="fs-3 fw-normal text-primary">Prospek karir</p>
        <hr>
        <hr>
        <p>Lulusan program studi S1 Manajemen dapat menjadi :</p>
        <ul>
            <li>Manajer tingkat pertama dibidang Pemasaran, Operasi, SDM, dan Keuangan, yang bekerja diberbagai institusi pemerintah dan swasta, dan di berbagai sektor: perbankan, manufaktur, agrobisnis, pertambangan,perdagangan, asuransi, dll.</li>
            <li>Analis dan konsultan di lembaga konsultan manajemen dan lembaga penelitian pemerintah maupun non-pemerintah.</li>
            <li>Wirausahawan muda mandiri</li>
            <li>Dosen magang / asisten di perguruan tinggi dan /atau <em>trainer</em> di lembaga pelatihan</li>
        </ul>
