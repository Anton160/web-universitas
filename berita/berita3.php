...
<body>
        ...
        <div class="container">
            ...
            <div class="offcanvas-sm offcanvas-end" tabindex="-1" id="iff" aria-labelledby="offcanvasNavbarLabel">
                <div class="offcanvas-header">
                    <h5 class="offcanvas-title" id="offcanvasNavbarLabel">Tetang kami</h5>
    ...
    <div class="container atas">
        <div class="row">
            <div class="col-md-8">
                <p class="fs-1 fst-lighter pt-5">Industri EPC Indonesia butuh lulusan teknik kimia ITB </p>
                <p class="text-muted">Selasa, 7 - Februari - 2023, 10:12:43</p>
                <br>
                <img src="../img/EPC-kuliah-umum.jpg" alt="" width="745px" class="img-fluid">
                <br><br><br>
                <p>Procurement, and Construction atau disingkat EPC merupakan bidang bisnis yang berfungsi dalam mengembangakn suatu industri kimia seperti industri pupuk, kilang minyak, dan lainnya. EPC membutuhkan lulusan teknik kimia, apalagi dari Institut Teknologi Bandung, dalam perencanaan pembangunan secara rinci di tingkat engineering dan dilanjutkan pada peralatan hingga tahap konstruksi.</p>
                <p>Maka dari itu, matakuliah TK4201 Seminar Keprofesian Teknik Kimia mengundang pembicara dari PT PP (Persero) Tbk., Eddy Herman Harun sebagai Direktur Operasi Bidang EPC. Acara tersebut dilaksanakan pada 27 Januari 2023 di Gedung TVST B, Kampus ITB yang dihadiri oleh seluruh mahasiswa Teknik Kimia semester 8.</p>
                <p>Kuliah ini diselenggarakan guna memperluas pengalaman serta pengetahuan para mahasiswa tingkat akhir terkait dunia pekerjaan. Materi yang dipaparkan berkenaan dengan industri EPC yang menjadi salah satu jenjang karier bagi lulusan Teknik kimia.</p>
                <p>PT PP (Persero) merupakan perusahaan EPC pertama yang bersifat BUMN. Eddy menegaskan bahwa EPC merupakan industri multidisiplin yang membutuhkan kolaborasi dari berbagai jurusan teknik seperti teknik kimia, teknik sipil, teknik fisika, dan teknik elektro.</p>
                <p>Dalam melaksanakan tanggung jawab sebagai seorang engineering di perusahaan EPC, manajemen risiko merupakan sebuah keharusan. Hal tersebut disebabkan proyek yang dilaksanakan merupakan suatu proses yang kompleks dan berlangsung lama sehingga ketelitian diperlukan untuk menghindari kerugian yang besar.</p>
                <p>Kompleksitas dari setiap proyek EPC menjadi tantangan bagi para fresh graduate yang belum memiliki pengalaman pekerjaan. Namun Eddy menegaskan bahwa jika memiliki keinginan untuk belajar yang kuat maka bekerja di EPC dapat memberikan pengalaman serta ilmu yang sangat berguna dikarenakan menghadapi kasus yang berbeda dan menarik setiap proyeknya. Oleh karena itu, dalam hal ini jurusan Teknik Kimia ITB didorong untuk bergabung dan memberikan kontribusi dalam industri EPC di Indonesia.</p>
