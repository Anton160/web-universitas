    ...
    <div class="pt-5 container">
        <div class="pt-3">
            ...
            <div class="container mt-3">
                <p class="fs-1 pt-5 text-primary fw-normal">Sarjana</p>
                <br>

                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-bs-toggle="tab" href="#snbp">SNBP</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#snbt">SNBT</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#mandiri">Mandiri</a>
                    </li>
                </ul>


                <div class="tab-content">
                    <div id="snbp" class="container tab-pane active">
                        <p class="fs-3 text-info pt-4 fw-semibold">Informasi umum</p>
                        <p class="text-secondary fw-lighter">Sehubungan dengan terbitnya Peraturan Menteri Pendidikan, Kebudayaan, Riset, dan Teknologi Republik Indonesia dengan nomor 48 Tahun 2022 tentang Penerimaan Mahasiswa Baru Program Diploma dan Program Sarjana pada Perguruan Tinggi Negeri, mulai tahun 2023 yang akan datang, program Seleksi Nasional Masuk Perguruan Tinggi Negeri (SNMPTN) tidak lagi dilaksanakan. Penerimaan mahasiswa baru di Perguruan Tinggi Negeri akan dilaksanakan melalui Seleksi Nasional Berdasarkan Prestasi (SNBP), yang dikelola oleh Balai Pengelolaan Pengujian Pendidikan (BPPP), Kementerian Pendidikan, Kebudayaan, Riset, dan Teknologi Republik Indonesia.</p>
                        <p class="text-secondary fw-lighter">Berkenaan dengan pemberlakuan Peraturan Menteri Pendidikan, Kebudayaan, Riset, dan Teknologi Republik Indonesia dengan nomor 48 Tahun 2022 tersebut, saat ini ITB masih menunggu ketentuan lebih lanjut mengenai pelaksanaan Seleksi Penerimaan Mahasiswa Baru tahun 2023 dari Kementerian Pendidikan, Kebudayaan, Riset, dan Teknologi Republik Indonesia.</p>
                        <p class="fs-3 text-info pt-4 fw-semibold">Jadwal pendaftaran</p>
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                <tr>
                                    <td>Pengumuman Kuota masuk</td>
                                    <td>12 Januari 2023</td>
                                </tr>
                                <tr>
                                    <td>Pembuatan Akun SNBP oleh Sekolah</td>
                                    <td>19-27 Januari 2023</td>
                                </tr>
                                <tr>
                                    <td>Pendaftaran SNBP</td>
                                    <td>14-26 Februari 2023</td>
                                </tr>
                                <tr>
                                    <td>Pengumuman SNBP</td>
                                    <td>26 Maret 2023</td>
                                </tr>
                            </tbody>
                        </table>
                        <p class="fs-3 text-info pt-4 fw-semibold">Biaya pendidikan</p>
                        <p class="text-secondary fw-lighter">Biaya pendidikan per semester bagi mahasiswa yang diterima di ITB melalui SNBP (dalam bentuk Uang Kuliah Tunggal/UKT) adalah sebagai berikut (dalam rupiah):</p>
                        ...
                        <p class="text-secondary fw-lighter">Biaya di atas adalah biaya yang dibayarkan siswa yang sudah digolongka sesuai kemampuan ekonomi siswa siswa dengan ekonomi rendah akan mendapatkan biaya yang rendah dan siswa dengan ekonomi tinggi membayar biaya yang tinggi</p>
                    </div>

                    <div id="snbt" class="container tab-pane fade"><br>
                    <p class="fs-3 text-info pt-4 fw-semibold">Informasi umum</p>
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>16-23 Februari 2023</td>
                                </tr>
                                <tr>
                                    <td>Pendaftaran SNBT</td>
                                    <td>23-29 Maret 2023</td>
                                </tr>
                                <tr>
                    ...
                    <div id="mandiri" class="container tab-pane fade"><br>
                    <p class="fs-3 text-info pt-4 fw-semibold">Informasi umum</p>
                        <p class="text-secondary fw-lighter">Jalur Seleksi Mandiri ITB (SM-ITB) memberi kesempatan lebih luas bagi siswa lulusan SMA baik WNI maupun WNA untuk mengikuti pendidikan program sarjana di Institut Teknologi Bandung.</p>
                        <p class="text-secondary fw-lighter">Seleksi Mandiri ITB (SM-ITB) diprogramkan sebagai jalur penerimaan mahasiswa program sarjana yang akan berjalan tanpa subsidi biaya. Mahasiswa yang diterima di ITB melalui program Seleksi Mandiri ITB (SM-ITB) bertanggung jawab untuk membiayai secara penuh pendidikan program sarjananya di ITB. ITB tidak memberikan subsidi biaya pendidikan bagi mahasiswa yang diterima melalui program Seleksi Mandiri ITB (SM-ITB). Namun demikian, proses penerimaan SM-ITB tetap menggunakan kriteria kemampuan akademik yang tinggi sebagai satu-satunya kriteria kelulusan seleksi. </p>
                        <p class="text-secondary fw-lighter">Khusus bagi calon peserta Seleksi Mandiri ITB (SM-ITB) yang merupakan pemilik Kartu Indonesia Pintar Kuliah (KIP-K) serta calon peserta yang berasal dari SMA/MA di wilayah 3T, ITB membebaskan biaya pendaftaran Seleksi Mandiri ITB (SM-ITB) dan biaya pendidikan di ITB. Tata cara pendaftaran calon peserta SM-ITB yang merupakan pemilik KIP-K serta calon peserta yang berasal dari SMA/MA di wilayah 3T dapat diperoleh di bagian lain dari halaman ini.</p>
                        <p class="fs-3 text-info pt-4 fw-semibold">Jadwal pendaftaran</p>
                        <table class="table table-borderless">
                            <thead class="table-dark">
                                <tr class="">
                        ...
                        <p class="text-secondary fw-lighter">Berbeda dengan jalur yang lain di jalur mandiri mahasiswa harus membayar UKT tingkat ke 5 kecuali mahasiswa memiliki KIP-K ia akan dimasukan ke UKT1</p>
                    </div>
                </div>
            </div>
        </div>
