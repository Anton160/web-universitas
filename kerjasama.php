...
<body>
    ...
    <div class="atas">
    <div class="container">
        <p class="text-primary fs-1 pt-5">Daftar Kerjasama</p>
        <div class="pt-5"></div>
    <table class="table table-striped atas">
        <thead>
            <tr>
                <th scope="col">No</th>
        ...
        <tbody>
            <tr>
                <th scope="row">1</th>
                <td>2020</td>
                <td>Kementerian Komunikasi dan Informatika (KEMKOMINFO)</td>
            </tr>
            <tr>
                <th scope="row">2</th>
                <td>2020</td>
            ...
            <tr>
                <th scope="row">3</th>
                <td>2020</td>
                <td>Pusat Pendidikan dan Pelatihan Badan Pusat Statistik</td>
            </tr>
            <tr>
                <th scope="row">4</th>
                <td>2020</td>
                <td>Badan Penelitian dan Pengembangan Sumber Daya Manusia Kementerian Komunikasi dan Informatika</td>
            </tr>
            <tr>
                <th scope="row">5</th>
                <td>2020</td>
                <td>Pusat Mata Nasional Rumah Sakit Mata Cicendo Bandung</td>
            </tr>
            <tr>
                <th scope="row">6</th>
                <td>2020</td>
            ...
            <tr>
                <th scope="row">7</th>
                <td>2020</td>
                <td>PT Siemens Indonesia</td>
            </tr>
            <tr>
                <th scope="row">8</th>
                <td>2020</td>
                <td>Pusat Penelitian dan Pengembangan Upaya Kesehatan Masyarakat</td>
            </tr>
            <tr>
                <th scope="row">9</th>
                <td>2020</td>
            ...
            <tr>
                <th scope="row">10</th>
                <td>2021</td>
                <td>PT Huawei Tech Investment (Indonesia)</td>
            </tr>
            <tr>
                <th scope="row">11</th>
                <td>2021</td>
            ...
            <tr>
                <th scope="row">14</th>
                <td>2021</td>
                <td>Université Toulouse III – Paul Sabatier </td>
            </tr>
            <tr>
                <th scope="row">15</th>
                <td>2021</td>
